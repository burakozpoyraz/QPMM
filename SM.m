...
%% MAIN FUNCTION
function [BER, num_bit_errors] = SM(num_iterations, Nt, Nr, M, P_tot, SNRdB, mod_type, detector_type)
    % Parameters///////////////////////////////////////////////////////////
    ...
    n_tot = nd + ns; % Number of total bits transmitted in a time slot
    ...
    for iter_index = 1 : num_iterations
        ...
        i = Bin2Dec(spatial_bits) + 1; % Activated antenna index

        x = zeros(Nt, 1);
        x(i) = sqrt(P_tot) * s; % Transmitted symbol array
        % =================================================================
...
function [detected_data_bits, detected_spatial_bits] = Detector(ss, H, y, Nt, M, P_tot, detector_type)
        ...
        case "JointMLD"
            ...
            for i = 1 : Nt
                ...
                for k = 1 : M
                    ...
                    error_value = norm(y - sqrt(P_tot) * hi * sk, "fro")^2;
    ...
    detected_spatial_bits = Dec2Bin(detected_i - 1, ns);
